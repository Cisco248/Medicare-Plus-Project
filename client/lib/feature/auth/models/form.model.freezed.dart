...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FormStatus&&(identical(other.state, state) || other.state == state));
}
...
class _FormStatus implements FormStatus {
  const _FormStatus({required this.state});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FormStatus&&(identical(other.state, state) || other.state == state));
}
