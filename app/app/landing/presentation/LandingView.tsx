...
import { getLandingContent } from "../data/landingRepository";
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-surface-500/30">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--color-brand-900)_0%,_transparent_55%)] opacity-60" />
        ...
        <PageShell>
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-zinc-400">
              Built for patients and providers — manage care without juggling multiple tools.
            </p>
          </div>
          ...
          <Card className="flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
            <div className="flex-1">
              ...
              <p className="mt-3 text-zinc-400">
                Join Medicare+ and experience a modern, secure way to manage healthcare
